			...
			<div class="fullwidthbanner1">
				...
				<!-- SLIDE  -->
					<li data-transition="parallaxtoright,parallaxtoleft" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off" >
						<!-- MAIN IMAGE -->
						<img src="{{ url('MNM/img/slider/slider-1/slider1.jpg') }}"  alt="slider1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
						<!-- LAYERS -->
						...
						<div class="tp-caption sfl" 
							...
							style="z-index: 5;"><img src="{{ url('MNM/img/slider/slider-1/img-slider1.png') }}" alt=""> 
						</div>
						...
						<div class="tp-caption customin" 
							...
							style="z-index: 9;"><a href="#" target="_blank"><img src="{{ url('MNM/img/slider/slider-1/shopping.jpg') }}" alt=""></a> 
						</div>
					</li>
				<!-- SLIDE  -->
					<li data-transition="parallaxtoright,parallaxtoleft" data-slotamount="7" data-masterspeed="600"  data-saveperformance="off" >
						<!-- MAIN IMAGE -->
						<img src="{{ url('MNM/img/slider/slider-1/slider2.jpg') }}"  alt="slider2"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
						<!-- LAYERS -->
						...
						<div class="tp-caption title-22 tp-fade tp-resizeme" 
							...
							style="z-index: 5; max-width: auto; max-height: auto; white-space: nowrap;">women accessories 
						</div>
						...
						<div class="tp-caption home2-title-1 tp-fade tp-resizeme" 
							...
							style="z-index: 6; max-width: auto; max-height: auto; white-space: nowrap;">collection sale off 
						</div>
						...
						<div class="tp-caption home2-title-2 tp-fade tp-resizeme" 
							...
							style="z-index: 7; max-width: ; max-height: ; white-space: nowrap;">Save up to 25% for all in your order in this month! 
						</div>
						...
						<div class="tp-caption tp-fade" 
							...
							style="z-index: 8;"><a href="#" target="_blank"><img src="{{ url('MNM/img/slider/slider-1/shopping.jpg') }}" alt=""></a> 
						</div>
					</li>	
				</ul>
			</div>
